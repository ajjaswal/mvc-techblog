...
The application must have these classes: `Employee`, `Manager`, `Engineer`, and `Intern`. The following tests for these classes (in the `_tests_` directory) **must all pass**:

![List of tests that must pass to meet requirements for this challenge](./Assets/Tests-For-Module-10.png)
